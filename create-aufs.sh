...
cd aufs4-standalone
git branch -r
git checkout origin/aufs4.19.17+
...
rm -rf ../tmp/linux-4.19.17+
mkdir -p ../tmp/linux-4.19.17+
cp -a fs ../tmp/linux-4.19.17+
cp -a include ../tmp/linux-4.19.17+
cp -a Documentation ../tmp/linux-4.19.17+
